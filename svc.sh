...
SVC_NAME="actions.runner.ju2tziseok-ci-cd-test.gangjiseog-ui-MacBookAir"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (ju2tziseok-ci-cd-test.gangjiseog-ui-MacBookAir)"
